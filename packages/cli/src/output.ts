...
export function reviewDocument(review: Review): Record<string, unknown> {
  return {
    ...
    ...(review.batchId === undefined ? {} : { batchId: review.batchId }),
    ...(review.parentReviewId === undefined ? {} : { parentReviewId: review.parentReviewId }),
    ...(review.revertsReviewId === undefined ? {} : { revertsReviewId: review.revertsReviewId }),
